...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query(value = "SELECT b.book_name, b.id, b.sold_amount, b.published_amount "
            + "FROM books b "
    ...
    List<Book> findAllBySuccessRateAndAuthorNamePart(@Param("name") String wildcardAuthorName);
}
